...
// Simulate distance calculation (in production, use Google Maps Distance Matrix API)
function simulateDistanceCalculation(
  ...
  return new Promise((resolve) => {
    setTimeout(() => {
      // Simulate distance based on number of stops and location string lengths
      const baseDistance = 25 + Math.random() * 50;
      const stopDistance = stops.length * (5 + Math.random() * 10);
