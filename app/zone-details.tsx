...
const SEED_ZONES: AvailableZone[] = [
  { id: "zone-1", name: "Lusaka Central Zone A", province: "Lusaka", town: "Lusaka" },
  { id: "zone-2", name: "Lusaka Central Zone B", province: "Lusaka", town: "Lusaka" },
  { id: "zone-3", name: "Kabulonga Residential", province: "Lusaka", town: "Lusaka" },
  { id: "zone-4", name: "Woodlands Area", province: "Lusaka", town: "Lusaka" },
];
...
export default function ZoneDetailsScreen() {
  ...
  const [allZones, setAllZones] = useState<AvailableZone[]>(SEED_ZONES);
  ...
  const loadZoneDetails = useCallback(async () => {
    ...
    try {
      ...
      const storedZones: AvailableZone[] = zonesRaw ? JSON.parse(zonesRaw) : SEED_ZONES;
