    ...
    <ScreenContainer>
      <ScrollView contentContainerStyle={{ paddingBottom: 100 }}>
        ...
        <View className="px-6 mb-6">
          ...
          {!isCollector && user?.role !== "recycler" && (
            <MenuItem
              icon="card-giftcard"
              label="Refer & Earn"
              subtitle="Invite friends, earn K50 credits"
          ...
          <MenuItem
            ...
            subtitle="Transfer to mobile money or bank"
          ...
          <MenuItem
            ...
            subtitle="Set up automatic transfers"
            onPress={() => router.push("/auto-withdrawal" as any)}
          />
          {(isCollector || user?.role === "recycler") && (
            <MenuItem
          ...
          {(isCollector || user?.role === "recycler") && (
            <MenuItem
              ...
              subtitle="View payment trends and statistics"
          ...
          {isCollector && (
            <MenuItem
              ...
              subtitle="View and share your official ID"
              onPress={() => router.push("/collector-badge" as any)}
            />
          )}
        </View>
