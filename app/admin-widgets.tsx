...
export default function AdminWidgetsScreen() {
  ...
  // Simulated data
  const activeCollectors = 12;
  const busyCollectors = 5;
  const offlineCollectors = 3;
  const newUsersToday = 8;

  const topCollectors = [
    { name: "John M.", pickups: 156, rating: 4.9 },
    { name: "Peter K.", pickups: 142, rating: 4.8 },
    { name: "Mary S.", pickups: 128, rating: 4.7 },
    { name: "David L.", pickups: 115, rating: 4.6 },
  ];

  const recentActivity = [
    { type: "pickup", text: "Pickup completed in Kabulonga", time: "2m ago" },
    { type: "payment", text: "Payment received K350", time: "5m ago" },
    { type: "user", text: "New user registered", time: "12m ago" },
    { type: "dispute", text: "Dispute resolved #1234", time: "25m ago" },
  ];
