...
const MOCK_REQUESTS: WithdrawalRequest[] = [
  {
    id: 1, providerId: 101, providerRole: "zone_manager", providerName: "John Banda",
    providerPhone: "0971234567", amount: "1200.00", withdrawalMethod: "mtn_momo",
    accountNumber: "0971234567", accountName: "John Banda", status: "pending",
    requestedAt: "2026-03-04T08:00:00Z",
  },
  {
    id: 2, providerId: 102, providerRole: "carrier_driver", providerName: "Mary Phiri",
    providerPhone: "0961234567", amount: "850.00", withdrawalMethod: "airtel_money",
    accountNumber: "0961234567", accountName: "Mary Phiri", status: "pending",
    requestedAt: "2026-03-04T09:30:00Z",
  },
  {
    id: 3, providerId: 103, providerRole: "zone_manager", providerName: "Peter Mwale",
    providerPhone: "0951234567", amount: "2500.00", withdrawalMethod: "bank_transfer",
    accountNumber: "1234567890", accountName: "Peter Mwale", status: "approved",
    reviewedBy: "finance_admin", reviewedAt: "2026-03-03T14:00:00Z",
    adminNotes: "Verified — proceed with bank transfer",
    requestedAt: "2026-03-03T10:00:00Z",
  },
  {
    id: 4, providerId: 104, providerRole: "carrier_driver", providerName: "Grace Tembo",
    providerPhone: "0941234567", amount: "450.00", withdrawalMethod: "mtn_momo",
    accountNumber: "0941234567", status: "completed",
    reviewedBy: "super_admin", reviewedAt: "2026-03-02T11:00:00Z",
    withdrawalReference: "ref-disburse-001", mtnDisbursementAccepted: true,
    requestedAt: "2026-03-02T08:00:00Z", completedAt: "2026-03-02T11:30:00Z",
  },
  {
    id: 5, providerId: 105, providerRole: "zone_manager", providerName: "David Lungu",
    providerPhone: "0931234567", amount: "300.00", withdrawalMethod: "mtn_momo",
    accountNumber: "0931234567", status: "rejected",
    reviewedBy: "finance_admin", reviewedAt: "2026-03-01T16:00:00Z",
    adminNotes: "Account number does not match registered details",
