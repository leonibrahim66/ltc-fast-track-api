...
export default function ZoneManagerAssignmentScreen() {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const storedZones: Zone[] = zonesRaw ? JSON.parse(zonesRaw) : SEED_ZONES;
  ...
  const openAssignModal = (manager: ZoneManager) => {
    ...
    setAssignToZoneId(manager.selectedZoneId || preselectedZoneId || "");
          ...
          <View className="bg-background rounded-t-3xl p-6">
            ...
            <FlatList
              ...
              renderItem={({ item }) => {
                ...
                return (
                  <TouchableOpacity
                    onPress={() => setAssignToZoneId(item.id)}
